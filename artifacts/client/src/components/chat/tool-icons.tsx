...
export function JiraIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#0052CC" {...props}>
...
export function TeamworkIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function ZohoIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#E61B23" {...props}>
...
export function StsIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const TOOL_ICON_MAP: Record<string, ComponentType<IconProps>> = {
  JIRA: JiraIcon,
  ZohoPeople: ZohoIcon,
  ZohoCRM: ZohoIcon,
